...
function gameStart() {
    // we store in a variable our "ul" element within the class "desk" and we store inside it our "li" element that was created before.
    // list[0] because once the console appear as an object
